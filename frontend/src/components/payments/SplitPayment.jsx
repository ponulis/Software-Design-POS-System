        ...
        try {
            ...
            for (const guest of guests) {
                ...
                if (guest.paymentMethod === 'Card') {
                    ...
                    // For split payments, card payments need to be confirmed via CardCheckout component
                    // The payment intent should already be confirmed when the user enters card details
