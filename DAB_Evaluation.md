# Our evaluation of DAB team's document
...
### Frontend
* In reservations page it is named Daily Schedule, but the days are different.
* There are only 2 fronted pages mockups/descriptions.


Based on these drawbacks we found, we evaluate the DAB's document 7/10.
